...
| A recorded process -> a step-by-step SOP (actions, owners, decisions, risks) | `lanes/sop/` | documentation-only delta (prose; not a wired/run lane this submission) |
